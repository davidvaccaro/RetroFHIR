...
import com.xinonix.hl7.fhir.stu3.ExpansionProfile.Status;
import com.xinonix.hl7.fhir.stu3.Identifier;

import com.xinonix.retrofhir.Parameters;
import com.xinonix.retrofhir.Prefix;
import com.xinonix.retrofhir.Modifier;
import com.xinonix.retrofhir.service.ExpansionProfileService;

import com.xinonix.hl7.fhir.stu3.ExpansionProfile;

public class ExpansionProfileInteractor extends ResourceInteractor<ExpansionProfileService, ExpansionProfile> {

    public static class ExpansionProfileComposer extends Composer<ExpansionProfileService, ExpansionProfile, ExpansionProfileComposer> {

        public ExpansionProfileComposer()
        {
            super((Class) ExpansionProfileService.class, (Class) ExpansionProfile.class);
        }
		...
		public ResourceInteractor.Composer setStatus(Modifier modifier, Prefix prefix, ExpansionProfile.Status Status)
		{
			return setParameter(Parameters.STATUS, modifier, prefix, Status);
		}

		public ResourceInteractor.Composer setStatus(Modifier modifier, ExpansionProfile.Status Status)
		{
			return setParameter(Parameters.STATUS, modifier, Status);
		}

		public ResourceInteractor.Composer setStatus(Prefix prefix, ExpansionProfile.Status Status)
		{
			return setParameter(Parameters.STATUS, prefix, Status);
		}
        			
		public ResourceInteractor.Composer setStatus(ExpansionProfile.Status Status)
		{
    ...
    public static <T> ExpansionProfileInteractor.ExpansionProfileComposer Composer()
    {
        return new ExpansionProfileComposer();
    }
