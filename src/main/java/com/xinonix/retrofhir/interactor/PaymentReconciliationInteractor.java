...
import com.xinonix.retrofhir.service.PaymentReconciliationService;

import com.xinonix.hl7.fhir.stu3.PaymentReconciliation;

public class PaymentReconciliationInteractor extends ResourceInteractor<PaymentReconciliationService, PaymentReconciliation> {

    public static class PaymentReconciliationComposer extends Composer<PaymentReconciliationService, PaymentReconciliation, PaymentReconciliationComposer> {

        public PaymentReconciliationComposer()
        {
            super((Class) PaymentReconciliationService.class, (Class) PaymentReconciliation.class);
        }
    ...
    public static <T> PaymentReconciliationInteractor.PaymentReconciliationComposer Composer()
    {
        return new PaymentReconciliationComposer();
    }
