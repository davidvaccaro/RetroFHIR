...
import com.xinonix.hl7.fhir.stu3.ServiceDefinition.Status;

import com.xinonix.retrofhir.Parameters;
import com.xinonix.retrofhir.Prefix;
import com.xinonix.retrofhir.Modifier;
import com.xinonix.retrofhir.service.ServiceDefinitionService;

import com.xinonix.hl7.fhir.stu3.ServiceDefinition;

public class ServiceDefinitionInteractor extends ResourceInteractor<ServiceDefinitionService, ServiceDefinition> {

    public static class ServiceDefinitionComposer extends Composer<ServiceDefinitionService, ServiceDefinition, ServiceDefinitionComposer> {

        public ServiceDefinitionComposer()
        {
            super((Class) ServiceDefinitionService.class, (Class) ServiceDefinition.class);
        }
		...
		public ResourceInteractor.Composer setStatus(Modifier modifier, Prefix prefix, ServiceDefinition.Status Status)
		{
			return setParameter(Parameters.STATUS, modifier, prefix, Status);
		}

		public ResourceInteractor.Composer setStatus(Modifier modifier, ServiceDefinition.Status Status)
		{
			return setParameter(Parameters.STATUS, modifier, Status);
		}

		public ResourceInteractor.Composer setStatus(Prefix prefix, ServiceDefinition.Status Status)
		{
			return setParameter(Parameters.STATUS, prefix, Status);
		}
        			
		public ResourceInteractor.Composer setStatus(ServiceDefinition.Status Status)
		{
		...
		public ResourceInteractor.Composer setTopic(Modifier modifier, Prefix prefix, CodeableConcept Topic)
		{
			return setParameter(Parameters.TOPIC, modifier, prefix, Topic);
		}

		public ResourceInteractor.Composer setTopic(Modifier modifier, CodeableConcept Topic)
		{
			return setParameter(Parameters.TOPIC, modifier, Topic);
		}

		public ResourceInteractor.Composer setTopic(Prefix prefix, CodeableConcept Topic)
		{
			return setParameter(Parameters.TOPIC, prefix, Topic);
		}
        			
		public ResourceInteractor.Composer setTopic(CodeableConcept Topic)
		{
			return setParameter(Parameters.TOPIC, Topic);
		}
    ...
    public static <T> ServiceDefinitionInteractor.ServiceDefinitionComposer Composer()
    {
        return new ServiceDefinitionComposer();
    }
