...
import com.xinonix.hl7.fhir.stu3.PlanDefinition.Status;

import com.xinonix.retrofhir.Parameters;
import com.xinonix.retrofhir.Prefix;
import com.xinonix.retrofhir.Modifier;
import com.xinonix.retrofhir.service.PlanDefinitionService;

import com.xinonix.hl7.fhir.stu3.PlanDefinition;

public class PlanDefinitionInteractor extends ResourceInteractor<PlanDefinitionService, PlanDefinition> {

    public static class PlanDefinitionComposer extends Composer<PlanDefinitionService, PlanDefinition, PlanDefinitionComposer> {

        public PlanDefinitionComposer()
        {
            super((Class) PlanDefinitionService.class, (Class) PlanDefinition.class);
        }
		...
		public ResourceInteractor.Composer setStatus(Modifier modifier, Prefix prefix, PlanDefinition.Status Status)
		{
			return setParameter(Parameters.STATUS, modifier, prefix, Status);
		}

		public ResourceInteractor.Composer setStatus(Modifier modifier, PlanDefinition.Status Status)
		{
			return setParameter(Parameters.STATUS, modifier, Status);
		}

		public ResourceInteractor.Composer setStatus(Prefix prefix, PlanDefinition.Status Status)
		{
			return setParameter(Parameters.STATUS, prefix, Status);
		}
        			
		public ResourceInteractor.Composer setStatus(PlanDefinition.Status Status)
		{
    ...
    public static <T> PlanDefinitionInteractor.PlanDefinitionComposer Composer()
    {
        return new PlanDefinitionComposer();
    }
