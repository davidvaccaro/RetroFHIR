...
import com.xinonix.hl7.fhir.stu3.RelatedPerson.Gender;

import com.xinonix.retrofhir.Parameters;
import com.xinonix.retrofhir.Prefix;
import com.xinonix.retrofhir.Modifier;
import com.xinonix.retrofhir.service.RelatedPersonService;

import com.xinonix.hl7.fhir.stu3.RelatedPerson;

public class RelatedPersonInteractor extends ResourceInteractor<RelatedPersonService, RelatedPerson> {

    public static class RelatedPersonComposer extends Composer<RelatedPersonService, RelatedPerson, RelatedPersonComposer> {

        public RelatedPersonComposer()
        {
            super((Class) RelatedPersonService.class, (Class) RelatedPerson.class);
        }
		...
		public ResourceInteractor.Composer setGender(Modifier modifier, Prefix prefix, RelatedPerson.Gender Gender)
		{
			return setParameter(Parameters.GENDER, modifier, prefix, Gender);
		}

		public ResourceInteractor.Composer setGender(Modifier modifier, RelatedPerson.Gender Gender)
		{
			return setParameter(Parameters.GENDER, modifier, Gender);
		}

		public ResourceInteractor.Composer setGender(Prefix prefix, RelatedPerson.Gender Gender)
		{
			return setParameter(Parameters.GENDER, prefix, Gender);
		}
        			
		public ResourceInteractor.Composer setGender(RelatedPerson.Gender Gender)
		{
    ...
    public static <T> RelatedPersonInteractor.RelatedPersonComposer Composer()
    {
        return new RelatedPersonComposer();
    }
