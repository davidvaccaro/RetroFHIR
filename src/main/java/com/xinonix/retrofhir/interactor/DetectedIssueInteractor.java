...
import com.xinonix.retrofhir.service.DetectedIssueService;

import com.xinonix.hl7.fhir.stu3.DetectedIssue;

public class DetectedIssueInteractor extends ResourceInteractor<DetectedIssueService, DetectedIssue> {

    public static class DetectedIssueComposer extends Composer<DetectedIssueService, DetectedIssue, DetectedIssueComposer> {

        public DetectedIssueComposer()
        {
            super((Class) DetectedIssueService.class, (Class) DetectedIssue.class);
        }
    ...
    public static <T> DetectedIssueInteractor.DetectedIssueComposer Composer()
    {
        return new DetectedIssueComposer();
    }
