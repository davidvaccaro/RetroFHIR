...
import com.xinonix.hl7.fhir.stu3.Measure.Status;

import com.xinonix.retrofhir.Parameters;
import com.xinonix.retrofhir.Prefix;
import com.xinonix.retrofhir.Modifier;
import com.xinonix.retrofhir.service.MeasureService;

import com.xinonix.hl7.fhir.stu3.Measure;

public class MeasureInteractor extends ResourceInteractor<MeasureService, Measure> {

    public static class MeasureComposer extends Composer<MeasureService, Measure, MeasureComposer> {

        public MeasureComposer()
        {
            super((Class) MeasureService.class, (Class) Measure.class);
        }
		...
		public ResourceInteractor.Composer setStatus(Modifier modifier, Prefix prefix, Measure.Status Status)
		{
			return setParameter(Parameters.STATUS, modifier, prefix, Status);
		}

		public ResourceInteractor.Composer setStatus(Modifier modifier, Measure.Status Status)
		{
			return setParameter(Parameters.STATUS, modifier, Status);
		}

		public ResourceInteractor.Composer setStatus(Prefix prefix, Measure.Status Status)
		{
			return setParameter(Parameters.STATUS, prefix, Status);
		}
        			
		public ResourceInteractor.Composer setStatus(Measure.Status Status)
		{
    ...
    public static <T> MeasureInteractor.MeasureComposer Composer()
    {
        return new MeasureComposer();
    }
