...
import com.xinonix.hl7.fhir.stu3.Library.Status;

import com.xinonix.retrofhir.Parameters;
import com.xinonix.retrofhir.Prefix;
import com.xinonix.retrofhir.Modifier;
import com.xinonix.retrofhir.service.LibraryService;

import com.xinonix.hl7.fhir.stu3.Library;

public class LibraryInteractor extends ResourceInteractor<LibraryService, Library> {

    public static class LibraryComposer extends Composer<LibraryService, Library, LibraryComposer> {

        public LibraryComposer()
        {
            super((Class) LibraryService.class, (Class) Library.class);
        }
		...
		public ResourceInteractor.Composer setStatus(Modifier modifier, Prefix prefix, Library.Status Status)
		{
			return setParameter(Parameters.STATUS, modifier, prefix, Status);
		}

		public ResourceInteractor.Composer setStatus(Modifier modifier, Library.Status Status)
		{
			return setParameter(Parameters.STATUS, modifier, Status);
		}

		public ResourceInteractor.Composer setStatus(Prefix prefix, Library.Status Status)
		{
			return setParameter(Parameters.STATUS, prefix, Status);
		}
        			
		public ResourceInteractor.Composer setStatus(Library.Status Status)
		{
    ...
    public static <T> LibraryInteractor.LibraryComposer Composer()
    {
        return new LibraryComposer();
    }
