...
import com.xinonix.retrofhir.service.ActivityDefinitionService;

import com.xinonix.hl7.fhir.stu3.ActivityDefinition;
import com.xinonix.hl7.fhir.stu3.CodeableConcept;
import com.xinonix.hl7.fhir.stu3.Identifier;

public class ActivityDefinitionInteractor extends ResourceInteractor<ActivityDefinitionService, ActivityDefinition> {

    public static class ActivityDefinitionComposer extends Composer<ActivityDefinitionService, ActivityDefinition, ActivityDefinitionComposer> {

        public ActivityDefinitionComposer()
        {
            super((Class) ActivityDefinitionService.class, (Class) ActivityDefinition.class);
        }
		...
		public ResourceInteractor.Composer setStatus(Modifier modifier, Prefix prefix, ActivityDefinition.Status Status)
		{
			return setParameter(Parameters.STATUS, modifier, prefix, Status);
		}

		public ResourceInteractor.Composer setStatus(Modifier modifier, ActivityDefinition.Status Status)
		{
			return setParameter(Parameters.STATUS, modifier, Status);
		}

		public ResourceInteractor.Composer setStatus(Prefix prefix, ActivityDefinition.Status Status)
		{
			return setParameter(Parameters.STATUS, prefix, Status);
		}
        			
		public ResourceInteractor.Composer setStatus(ActivityDefinition.Status Status)
		{
    ...
    public static <T> ActivityDefinitionInteractor.ActivityDefinitionComposer Composer()
    {
        return new ActivityDefinitionComposer();
    }
