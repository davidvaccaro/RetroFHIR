...
import com.xinonix.hl7.fhir.stu3.Practitioner.Gender;

import com.xinonix.retrofhir.Parameters;
import com.xinonix.retrofhir.Prefix;
import com.xinonix.retrofhir.Modifier;
import com.xinonix.retrofhir.service.PractitionerService;

import com.xinonix.hl7.fhir.stu3.Practitioner;

public class PractitionerInteractor extends ResourceInteractor<PractitionerService, Practitioner> {

    public static class PractitionerComposer extends Composer<PractitionerService, Practitioner, PractitionerComposer> {

        public PractitionerComposer()
        {
            super((Class) PractitionerService.class, (Class) Practitioner.class);
        }
		...
		public ResourceInteractor.Composer setCommunication(Modifier modifier, Prefix prefix, CodeableConcept Communication)
		{
			return setParameter(Parameters.COMMUNICATION, modifier, prefix, Communication);
		}

		public ResourceInteractor.Composer setCommunication(Modifier modifier, CodeableConcept Communication)
		{
			return setParameter(Parameters.COMMUNICATION, modifier, Communication);
		}

		public ResourceInteractor.Composer setCommunication(Prefix prefix, CodeableConcept Communication)
		{
			return setParameter(Parameters.COMMUNICATION, prefix, Communication);
		}
        			
		public ResourceInteractor.Composer setCommunication(CodeableConcept Communication)
		{
			return setParameter(Parameters.COMMUNICATION, Communication);
		}
		...
		public ResourceInteractor.Composer setGender(Modifier modifier, Prefix prefix, Practitioner.Gender Gender)
		{
			return setParameter(Parameters.GENDER, modifier, prefix, Gender);
		}

		public ResourceInteractor.Composer setGender(Modifier modifier, Practitioner.Gender Gender)
		{
			return setParameter(Parameters.GENDER, modifier, Gender);
		}

		public ResourceInteractor.Composer setGender(Prefix prefix, Practitioner.Gender Gender)
		{
			return setParameter(Parameters.GENDER, prefix, Gender);
		}
        			
		public ResourceInteractor.Composer setGender(Practitioner.Gender Gender)
		{
    ...
    public static <T> PractitionerInteractor.PractitionerComposer Composer()
    {
        return new PractitionerComposer();
    }
